...
prerequisites: []
buildsUpon: []
leadsTo: ["kubectl-apply","scheduler-assigns-pod","kubelet-runs-container","service-exposes-pod"]
related: ["running","scheduling","terminating"]
...
## Related
running, scheduling, terminating
