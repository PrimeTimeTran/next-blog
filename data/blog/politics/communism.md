...
But when we keep using ideological names that no longer match lived reality, we make it easier to talk _about_ each other instead of _to_ each other. The label does the thinking for us. Nuance becomes optional.
